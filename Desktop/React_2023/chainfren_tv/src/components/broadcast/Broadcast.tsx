...
export function BroadcastWithControls({
  ...
  return (
    ...
    >
      <Broadcast.Container className="w-full h-full overflow-hidden  bg-black-primary-text border border-border-gray rounded-lg">
        ...
        <Broadcast.ErrorIndicator
          ...
          className="absolute select-none inset-0 text-center b flex flex-col items-center justify-center gap-4 duration-1000 data-[visible=true]:animate-in data-[visible=false]:animate-out data-[visible=false]:fade-out-0 data-[visible=true]:fade-in-0"
        >
        ...
        <Broadcast.Controls className="bg-gradient-to-b gap-1 px-3 md:px-3 py-1.5 flex-col-reverse flex from-black/20 via-80% via-black/30 duration-1000 to-black/60 data-[visible=true]:animate-in data-[visible=false]:animate-out data-[visible=false]:fade-out-0 data-[visible=true]:fade-in-0">
          <div className="flex justify-between gap-4">
            <div className="flex flex-1 items-center gap-3">
              <Broadcast.VideoEnabledTrigger className="w-6 h-6 hover:scale-110 text-white transition-all flex-shrink-0">
              ...
              <Broadcast.AudioEnabledTrigger className="w-6 h-6 hover:scale-110 text-red-500 transition-all flex-shrink-0">
            ...
            <div className="flex sm:flex-1 md:flex-[1.5] justify-end items-center gap-2.5">
              <Broadcast.FullscreenIndicator matcher={false} asChild>
                <Settings className="w-6 h-6 transition-all flex-shrink-0 text-white hover:scale-110" />
              ...
              <Broadcast.PictureInPictureTrigger className="w-6 h-6 hover:scale-110 text-white transition-all flex-shrink-0">
                <PictureInPictureIcon className="w-full h-full text-white" />
              </Broadcast.PictureInPictureTrigger>

              <Broadcast.FullscreenTrigger className="w-6 h-6 p-1 text-white transition-all flex-shrink-0">
        ...
        <Broadcast.LoadingIndicator asChild matcher={false}>
          <div className="absolute overflow-hidden py-1 px-2 rounded-full top-1 left-1 bg-black/50 flex items-center backdrop-blur">
            ...
            <Broadcast.StatusIndicator
              ...
              matcher="pending"
            >
              <div className="bg-[#DC7609] h-1.5 w-1.5 rounded-full animate-pulse" />
              <span className="text-xs text-white select-none">PENDING</span>
            </Broadcast.StatusIndicator>
            ...
            >
              ...
              <span className="text-xs text-white text-primary-text select-none">
                IDLE
              </span>
            </Broadcast.StatusIndicator>
          </div>
      ...
      <div className="flex justify-between w-full items-center mt-2">
        <button className="rounded-md px-4 py-2 bg-slate-200 hover:bg-slate-100 ">
          {/* Open viewer URL onclick */}
          <Link
            ...
            rel="noreferrer"
          >
            Open viewer URL <BsArrowUpRight className="h-5 w-5" />
          </Link>
        </button>
        <Broadcast.EnabledTrigger className="rounded-md bg-slate-200 px-4 py-2  hover:bg-slate-100">
          <Broadcast.EnabledIndicator
            className="gap-1 flex items-center justify-center"
            matcher={false}
          >
            <EnableVideoIcon className="w-7 h-7 text-green-500" />
          ...
          <Broadcast.EnabledIndicator
            ...
            matcher={true}
          >
            <StopIcon className="w-7 h-7 text-red-500" />
